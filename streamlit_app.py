...
with tabs[0]:
    ...
    st.markdown("<h4 style='text-align: center;'>💬 Review your code using free LLMs via OpenRouter</h4>", unsafe_allow_html=True)
    ...
    <div class="footer-container">
        <div class="footer-links">
            <a href="https://www.linkedin.com/in/aritramukherjeeofficial/" target="_blank">🔗 LinkedIn</a>
            <a href="https://github.com/AritraOfficial" target="_blank">💻 GitHub</a>
            <a href="https://arim-official.netlify.app/" target="_blank">🌐 Portfolio</a>
            <a href="mailto:aritra.work.official@gmail.com" target="_blank">✉️ Mail</a>
        </div>
